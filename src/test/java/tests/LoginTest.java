...
//    }
    ...
    public void connectDb(){
        dataLogin = (String[][])ReadExcel.getExcelData("Login");
    ...
    public void LG_3(){
        loginPage.logInBy("Smart Tv, Website", dataLogin[1][1], dataLogin[1][2]);
    ...
    public void LG_4(){
        loginPage.logInBy("Quản lý thiết bị",dataLogin[1][1], dataLogin[1][2]);
    ...
    public void LG_5(){
        loginPage.logInBy("Thông báo",dataLogin[1][1], dataLogin[1][2]);
    ...
    public void LG_47(){
        loginPage.loginSuccess(dataLogin[1][1],dataLogin[1][2]);
    ...
    public void LG_37(){
        loginPage.loginSuccess(dataLogin[1][1],dataLogin[1][2]);
        loginPage.viewUserInform();
        loginPage.checkUserInform(dataLogin[1][1],"all");
    }
    @Severity(CRITICAL)
    ...
    public void LG_10(){
        loginPage.logOut("Thành công");
        loginPage.goToLogin();
        loginPage.inputUserName(dataLogin[4][1]);
    }
